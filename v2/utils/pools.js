...
export function getPoolByTokenMintAddresses(coinMintAddress, pcMintAddress) {
    const pool = LIQUIDITY_POOLS.find((pool) => (pool.coin.mintAddress === coinMintAddress && pool.pc.mintAddress === pcMintAddress) ||
...
export function getPoolListByTokenMintAddresses(coinMintAddress, pcMintAddress, ammIdOrMarket) {
    const pool = LIQUIDITY_POOLS.filter((pool) => {
        if (coinMintAddress && pcMintAddress) {
            if (((pool.coin.mintAddress === coinMintAddress && pool.pc.mintAddress === pcMintAddress) ||
                (pool.coin.mintAddress === pcMintAddress && pool.pc.mintAddress === coinMintAddress)) &&
                pool.version === 4 &&
                pool.official) {
...
export function getLpMintByTokenMintAddresses(coinMintAddress, pcMintAddress, version = [3, 4]) {
    const pool = LIQUIDITY_POOLS.find((pool) => ((pool.coin.mintAddress === coinMintAddress && pool.pc.mintAddress === pcMintAddress) ||
        (pool.coin.mintAddress === pcMintAddress && pool.pc.mintAddress === coinMintAddress)) &&
...
export function getLpListByTokenMintAddresses(coinMintAddress, pcMintAddress, ammIdOrMarket, version = [4]) {
    const pool = LIQUIDITY_POOLS.filter((pool) => {
        if (coinMintAddress && pcMintAddress) {
            if (((pool.coin.mintAddress === coinMintAddress && pool.pc.mintAddress === pcMintAddress) ||
                (pool.coin.mintAddress === pcMintAddress && pool.pc.mintAddress === coinMintAddress)) &&
...
export function canWrap(fromMintAddress, toMintAddress) {
